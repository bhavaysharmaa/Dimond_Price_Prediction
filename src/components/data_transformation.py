...
class DataTransformation:
    ...
    def get_data_transformation_obj(self):
        ...
        try:
            ...
            # Define which columns should be ordinal enoded and which should be scaled
            ...
            logging.info('Error is Data Transformation')
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            # Transforamting using preprocessor object
